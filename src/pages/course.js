...
export default () => {
  return (
    <div className={styles.webpackConfigContainer}>
      <h2>Time to learn webpack properly</h2>
      <p>
      ...
      <p>
        To learn webpack properly you must get your hands dirty and do the work.
        It's not enough to glance over some generated webpack configs.
      </p>
      ...
      <p>
        With this email course you will learn webpack from the ground up. Using
        industry best practices. <i>And it's free!</i>
      </p>
