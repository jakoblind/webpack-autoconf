      ...
      <Layout title="Learn webpack" hideHeader={true}>
        <div className={styles.webpackConfigContainer}>
          ...
          <p style={{ marginTop: 0 }}>
            ...
            does that all even mean in the context of a build setup for a web
            app?
          </p>
          <p>
            You stumble around with webpack, browsing the docs, tutorials,
            blogs, YouTube and Stack Overflow to try to make sense of it all.
          ...
          <p>
            ...
            (whatever that is?) and another tutorial doesn't mention that at
            all.
          </p>
          <p>
          ...
          <p>
            <b>
              ➡️ You'll know how create-react-app, Gatsby, Next.js, etc work
              under the hood
            </b>
          </p>
          <p>
            Make sense of the ejected create-react-app webpack config. Know how
            to extend it and adjust it to your needs. Extend Gatsby in
            gatby-node.js with ease.
          </p>
          <p>
            <b>
          ...
          <p>
            And in those cases when you get stuck, you know what to google for
            and interpret the result. You are able to not only read and
            understand the webpack docs but you'll enjoy it.
          </p>
          <p>
            <b>
              ➡️ Become a better dev to get better chances of getting the job
              you want
            </b>
          </p>
          <p>
          ...
          <p>
            ...
            web app with webpack. This approach makes webpack super easy to
            learn.
          </p>
          <p>
            But it’s not enough just to learn the syntax. You’ll learn all about
            the dependencies like Babel, webpack-dev-server, and React hot
            loader. You learn what they do and why you need them. This way you
            can use the dependencies to your advantage, to make your app fast
            and beautiful for your users.
          </p>
          <p>
            You’ll also learn how to squeeze out every juice of webpack to make
            your app as fast as possible by using advanced techniques such as
          ...
          <p>
            This book is a handbook for creating enterprise-ready production
            apps with webpack. These are the main topics covered:
          </p>
          <ul>
          ...
          <p>
            ...
            You start from scratch and you will finish up with a complete
            webpack project that you can put in production. This tutorial is
          ...
          <p>
            ...
            makes you super productive <i>and</i> use tools and techniques to
            get the lowest possible bundle size for the production build. You’ll
            also learn about the internals of webpack. Loaders, plugins,
          ...
          <p>
            ...
            part of the book, you will have recipes that you can use to create
            the app you want to create - so you don't have read long and
            outdated medium-articles to get the code you need.
          </p>
          <div>
            <HiddenSampleChapterSignupForm />
          </div>
          ...
          <p>
            As a developer, the best investment you can make is to invest in
            your skills. When you know webpack you will be a more complete
            frontend dev. It will set you up for getting promotions.
          </p>
          <p>
            And if you're looking for a job, talking fluently in interviews
            about how to use code splitting and tree shaking with webpack will
            make you stand out from other frontend devs.
          </p>
          <h3>Book details</h3>
          ...
          <div>
            ...
            years of experience as a professional dev and I have been coding as
            a hobby since I was a kid.
            <br />
            <br />
          ...
          <p>
            ...
            the book because there is a new version of webpack or if I extend
            the book with new material, you will get the update straight in your
            inbox with no additional cost.{' '}
          </p>
          <p>
